...
public class VentanaBienvenida extends JFrame implements Runnable
{
    ...
    public VentanaBienvenida()
    {
         ...
         * Los otros dos intermedios seran el limite de la forma, ene este caso le estamos dando los mismos límites que el jFrame
    ...
    private void initComponents() {
        ...
        jlTitulo.setText("<html>Laboratorio 3\n<br>\nArquitectura De Software</html>");
        ...
        jlIntegrantes.setText("<html>Integrantes:<br>\nCésar Augusto Muñoz Roldán<br>\nMaría Del Pilar Arroyave Patiño<br>\nNatalia Pérez Enamorado<br>\nSebastián Montoya Jiménez<br>\n</html>");
