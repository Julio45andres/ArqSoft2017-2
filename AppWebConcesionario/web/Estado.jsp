...
<div class="container">
    ...
    <form>
        ...
        <div class="form-group">
            <label>Codigo:</label>
            <input type="text" class="form-control" ng-model="estado.codigo" placeholder="Codigo" maxlength="5">
        </div>          
        <div class="form-group">
            <label>Descripción:</label>
            <input type="text" class="form-control" ng-model="estado.descripcion" placeholder="Descripción" maxlength="250">
        </div>
        <div class="form-group">
            <label>Estado:</label>
            <input type="text" class="form-control" ng-model="estado.estado" placeholder="Estado" maxlength="30">
        </div>
